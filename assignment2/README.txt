...
a persistence unit "MavenWebAppPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "MavenWebApp/pom.xml":
...
artifact ("MavenWebApp.war") is already built. You can build
